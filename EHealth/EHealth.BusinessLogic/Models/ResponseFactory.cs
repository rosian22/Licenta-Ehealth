namespace EHealth.BusinessLogic.Models
{
    ...
    {
        public static Response ErrorReponse => CreateResponse(false, (int)ResponseCode.ErrorAnErrorOccurred);
        public static Response InvalidInputResponse => CreateResponse(false, (int)ResponseCode.ErrorInvalidInput);
        public static Response SuccessResponse => CreateResponse(true, (int)ResponseCode.Success);
        public static Response PartialSuccessResponse => CreateResponse(true, (int)ResponseCode.SuccessPartial);
        ...
        public static Response Success(int responseCode = (int)ResponseCode.Success)
        {
